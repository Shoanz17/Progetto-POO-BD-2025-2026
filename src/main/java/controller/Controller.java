...
public class Controller {
    ...
    public Utente getUtenteDaFattura(Fattura fattura) {
        return fattura.getUtente();
    }

    public String getNomeUtenteDaFattura(Fattura fattura) {
        return fattura.getUtente().getNome();
    }
